...
class ContactController extends AbstractController
{
    ...
    public function index(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            Notre équiupe va vous repondre dans les meilleurs délais.');
            ...
            if ($formData['content']== null){
                ...
                $mail = new Mail();
                $mail->send('lacaveauxdelices45@gmail.com', 'La Cave aux Délices',
                    'Vous avez reçu une nouvelle demande de contact', $content);
            }
        }
